...
var URL_INSERT = () => { return '/jpanel/'+url_insert+'&'+item[0]+'='+document.getElementById(item[0]).value+'&'+item[1]+'='+document.getElementById(item[1]).value;
                        }
...
var URL_UPDATE = () => { return  '/jpanel/'+url_update+'&'+item[0]+'='+document.getElementById(item[0]+'_').value+'&'+item[1]+'='+document.getElementById(item[1]+'_').value;
                        }
...
var URL_DELETE = () => { return  '/jpanel/'+url_delete+'&'+item[0]+'='+document.getElementById(item[0]+'_').value+'&'+item[1]+'='+document.getElementById(item[1]+'_').value;
                        }

var URL_SEARCH = () => { return  '/jpanel/'+url_search+'&'+item[0]+'='+document.getElementById("SEARCH_TEXT").value+'&'+item[1]+'='+document.getElementById("SEARCH_TEXT1").value;
                        }
