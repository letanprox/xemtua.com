...
module.exports = async (callback, scanner) => {
    ...
    if (scanner.req_bundle.index === 'topviewshortvideo'){
        let model = scanner["modelxxemtua.com/danhsachshortvideo"];
    ...
    if (scanner.req_bundle.index === 'relateshortvideo'){
        let model = scanner["modelxxemtua.com/danhsachrelate"];
        ...
        model = scanner["modelxxemtua.com/danhsachshortvideo"];
        let arr = [];
    ...
    if (scanner.req_bundle.index === 'getoneshortvideo'){
        ...
        if(index > 0){
            ...
            if(countdex >= 1){
                ...
                model = scanner["modelxxemtua.com/danhsachlinkshortvideo"];
                query = {index:Number(index)}
                ...
                if(checkurl === 0){
                    ...
                    model = scanner["modelxxemtua.com/danhsachtokenshortvideo"];
